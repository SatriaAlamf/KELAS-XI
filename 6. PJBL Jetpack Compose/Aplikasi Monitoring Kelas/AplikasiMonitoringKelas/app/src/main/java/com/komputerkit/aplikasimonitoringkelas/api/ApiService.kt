...
interface ApiService {
    ...
    // Guru Pengganti Endpoints
    @POST("guru-pengganti")
    suspend fun storeGuruPengganti(
        @Header("Authorization") token: String,
        @Body request: GuruPenggantiRequest
    ): Response<GuruPenggantiResponse>
    
    // KEPSEK COMPREHENSIVE LIST ENDPOINTS
    @GET("guru-mengajar/kepsek/comprehensive")
    suspend fun getKepsekComprehensiveList(
        @Header("Authorization") token: String,
        @Query("hari") hari: String? = null,
        @Query("kelas_id") kelasId: Int? = null,
        @Query("status_mengajar") statusMengajar: String? = null,
        @Query("status_pengganti") statusPengganti: String? = null,
        @Query("durasi_min") durasiMin: Int? = null,
        @Query("durasi_max") durasiMax: Int? = null,
        @Query("tanggal_from") tanggalFrom: String? = null,
        @Query("tanggal_to") tanggalTo: String? = null,
        @Query("has_pengganti") hasPengganti: String? = null
    ): Response<KepsekComprehensiveResponse>
    
    @POST("guru-mengajar/kepsek/comprehensive")
    suspend fun getKepsekComprehensiveListPost(
        @Header("Authorization") token: String,
        @Body request: KepsekComprehensiveRequest
    ): Response<KepsekComprehensiveResponse>
