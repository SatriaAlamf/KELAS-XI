...
Route::get('/jadwals', [JadwalController::class, 'index']); // Get all jadwals with filters
...
// NEW FILTER ENDPOINTS - untuk filter jadwal berdasarkan jurusan, tingkat, dll
Route::get('/jadwals/filter', [JadwalController::class, 'filter']); // Advanced filtering
Route::get('/jadwals/jurusan/{jurusan}', [JadwalController::class, 'getByJurusan']); // Filter by jurusan
Route::get('/jadwals/tingkat/{tingkat}', [JadwalController::class, 'getByTingkat']); // Filter by tingkat
Route::get('/jadwals/filter-options', [JadwalController::class, 'getFilterOptions']); // Get all filter options
...
// KEPSEK COMPREHENSIVE LIST - untuk ListKepsekScreen dengan filter kompleks
Route::get('/guru-mengajar/kepsek/comprehensive', [GuruMengajarController::class, 'getKepsekComprehensiveList']);
Route::post('/guru-mengajar/kepsek/comprehensive', [GuruMengajarController::class, 'getKepsekComprehensiveList']);
...
// Guru Pengganti endpoints - CRUD untuk guru pengganti
Route::get('/guru-pengganti', [GuruMengajarController::class, 'indexGuruPengganti']); // Get all with filters
Route::post('/guru-pengganti', [GuruMengajarController::class, 'storeGuruPengganti']); // Create
Route::get('/guru-pengganti/{id}', [GuruMengajarController::class, 'showGuruPengganti']); // Show detail
Route::put('/guru-pengganti/{id}', [GuruMengajarController::class, 'updateGuruPengganti']); // Update
Route::delete('/guru-pengganti/{id}', [GuruMengajarController::class, 'destroyGuruPengganti']); // Delete
Route::get('/guru-pengganti/guru-mengajar/{guruMengajarId}', [GuruMengajarController::class, 'getGuruPenggantiByGuruMengajar']); // By guru mengajar
Route::get('/guru-pengganti/aktif/list', [GuruMengajarController::class, 'getGuruPenggantiAktif']); // Only aktif status
